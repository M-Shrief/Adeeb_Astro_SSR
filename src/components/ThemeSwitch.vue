...
const reflectPreference = () => {
  document.firstElementChild?.setAttribute('color-scheme', theme.value as string)
...
window.onload = () => {
  ...
  (document as Document).querySelector('#theme-toggle')?.addEventListener('click', onClick)
}
